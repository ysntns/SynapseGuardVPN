...
- Surfaced connection errors (including timeouts) directly on the home screen status and snackbar, while persisting the last selected server for subsequent reconnects.
...
- Bağlantı hataları ve zaman aşımı durumları ana ekranda durum metni ve snackbar üzerinden gösterilirken, seçilen son sunucu sonraki bağlantılar için hatırlanıyor.
